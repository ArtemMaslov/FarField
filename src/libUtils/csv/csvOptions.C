...
Utils::csvOptions::csvOptions
(
    const fileName& path,
    const bool hasHeader,
    const char* const columnSeparator,
    const char* const rowSeparator,
    const bool skipLeadingAndTrailingSpaces
)
:
    path(path),
    columnSeparator(columnSeparator),
    rowSeparator(rowSeparator),
    skipLeadingAndTrailingSpaces(skipLeadingAndTrailingSpaces),
    hasHeader(hasHeader)
{
}
